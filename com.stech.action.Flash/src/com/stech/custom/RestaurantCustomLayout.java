...
public class RestaurantCustomLayout implements TabContentFactory {
	...
	public void flashRestaurantList(int type) {
		...
		AsyncRestaurantLoader asyncRestaurantLoader = new AsyncRestaurantLoader(
				activity);
		ListAdapter adapter = asyncRestaurantLoader.loadRestaurantListAdapter(
				type, new RestaurantListCallBack() {
					@Override
		...
		listView.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
				...
				Restaurant click_item = (Restaurant) listView
...
//		});
		...
		builder.setTitle(restaurant.getName()).setView(rest_details_View);
//		Logger.i(LOGTAG, "size:"+restaurant.getPhoneList().size());
		if(restaurant.getPhoneList()!=null&&restaurant.getPhoneList().size()>0){
					...
					new DialogInterface.OnClickListener() {
						public void onClick(DialogInterface dialog,
							...
							Intent myIntentDial = new Intent(
									...
									Uri.parse("tel:"+ restaurant.getPhoneList().get(0)));
